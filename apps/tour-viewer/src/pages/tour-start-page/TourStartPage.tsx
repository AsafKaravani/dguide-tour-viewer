          ...
          <Box className="flex justify-between">
            ...
            <Box className="flex gap-3 items-center">
              <img
                ...
                onClick={() =>
                  window.open(
                    `https://waze.com/ul?ll=${_p.tour.stops[0].stop_location.latitude},${_p.tour.stops[0].stop_location.longitude}`
                  )
                }
                width={20}
              />
              <img
                onClick={() => {
                  window.open(
                    `https://www.google.com/maps/@${_p.tour.stops[0].stop_location.latitude},${_p.tour.stops[0].stop_location.longitude},17z`
                  );
                }}
